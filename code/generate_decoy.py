...
def generate_decoy_files(main_model, weight_model, user_vec_dict):
    ...
    # picked_attr_list.extend(other considered file attributes)
    # ... ...
    ...
    # find decoy files' index according to selected file attributes
    decoy_index_list = []
